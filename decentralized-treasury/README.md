...
| votingLedgerScheduler | object | `{"affinity":{},"deploymentAnnotations":{},"enabled":true,"extraEnvVars":[],"image":{"pullPolicy":"","repository":"minafoundation/dt-voting-ledger-scheduler","tag":""},"lifecycleIds":[],"nodeSelector":{},"periodsPerLifecycle":4,"podAnnotations":{},"pollIntervalSeconds":30,"replicaCount":1,"resources":{},"sqlite":{"keepLastN":0},"stakingLedgersDirectory":"/staking-ledgers","stakingLedgersExistingClaim":"","stakingLedgersKeepLastN":1,"stakingLedgersSizeLimit":"","stakingLedgersSyncIntervalSeconds":300,"tolerations":[]}` | Builds voting ledgers from staking ledger archives. The sole producer of the lifecycle SQLite databases, and the only workload that never touches Postgres. |
